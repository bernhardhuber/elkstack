...
public class DatenpumpeUdpMessagesSubmitterIT
{
    ...
    @Before
    public void setUp() {
        this.datenpumpe = new DatenpumpeBuilder().host(new Configuration().getUdpHost()).port(new Configuration().getUdpPort()).specificConfiguration("version", (Object)"1.1").build();
    }
